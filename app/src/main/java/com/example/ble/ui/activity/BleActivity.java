...
import com.example.ble.androidble.ble.OnDeviceSearchListener;
import com.example.ble.androidble.permission.PermissionListener;
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch (item.getItemId()) {
                    case R.id.navigation_item_home:
                        // 处理菜单项1的点击事件
                        startActivity(new Intent(BleActivity.this, MainActivity.class));
                        break;
                    case R.id.navigation_item_share:
                        // 处理菜单项1的点击事件
                        startActivity(new Intent(BleActivity.this, ShareActivity.class));
                        break;
