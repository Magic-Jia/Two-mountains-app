...
public class FAQFragment extends BaseFragment {
    ...
    protected void initData() {
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles1), getActivity().getResources().getString(R.string.faqs1)));
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles2), getActivity().getResources().getString(R.string.faqs2)));
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles3), getActivity().getResources().getString(R.string.faqs3)));
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles4), getActivity().getResources().getString(R.string.faqs4)));
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles5), getActivity().getResources().getString(R.string.faqs5)));
        fAQs.add(new FAQ(getActivity().getResources().getString(R.string.faqs_titles6), getActivity().getResources().getString(R.string.faqs6)));
