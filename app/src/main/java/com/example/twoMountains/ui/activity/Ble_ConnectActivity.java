...
public class Ble_ConnectActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        button_connect = findViewById(R.id.btn_connectXpedition);
        //侧边抽屉
        ...
        button_turnOn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!isEnable()) {
                    ...
                    Toast.makeText(Ble_ConnectActivity.this,"Bluetooth successfully opened",Toast.LENGTH_SHORT).show();

                } else {
                    Toast.makeText(Ble_ConnectActivity.this,"Bluetooth is already turned on",Toast.LENGTH_SHORT).show();
                }
            }
        });
